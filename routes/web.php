...
/**
 * Recuros:
 * /series          'GET' => pegar (todas as) séries
 * /series/:id      'GET' => pegar série específica
 * /series          'POST' => inserir nova série
 * /series/:id      'PUT' => atualizar uma série (todos os dados)
 * /series/:id      'DELETE' => remover uma série
 *
 * /episodios
 * /episodios/:id
 * /cursos
